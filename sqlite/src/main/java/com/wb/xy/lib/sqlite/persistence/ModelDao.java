package com.wb.xy.lib.sqlite.persistence;

import android.database.sqlite.SQLiteDatabase;

import com.wb.xy.lib.sqlite.meta.Page;
...
public abstract class ModelDao<TModel> extends AbstractDao<TModel> implements IModelDao<TModel> {
    ...
    protected List<TModel> find(String sql, Object... params) {
    ...
    protected List<TModel> find(Sql sql, boolean cached) {
        return super.find(super.getMClass(), sql, cached);
    }

    protected List<TModel> findTop(int top, String sql, Object... params) {
        return super.findTop(super.getMClass(), top, sql, params);
    }

    protected List<TModel> findTop(int top, Sql sql) {
        return super.findTop(super.getMClass(), top, sql);
    }

    protected List<TModel> findTop(int top, Sql sql, boolean cached) {
        return super.findTop(super.getMClass(), top, sql, cached);
    }

    protected Page<TModel> findByPage(boolean isPageable, int currentPage, int recordsPerPage, String sql, Object... params) {
        return super.findByPage(super.getMClass(), isPageable, currentPage, recordsPerPage, sql, params);
    }

    protected Page<TModel> findByPage(boolean isPageable, int currentPage, int recordsPerPage, Sql sql) {
        return super.findByPage(super.getMClass(), isPageable, currentPage, recordsPerPage, sql);
    }

    protected Page<TModel> findByPage(boolean isPageable, int currentPage, int recordsPerPage, Sql sql, boolean cached) {
    ...
    @Override
    public TModel getById(Object primaryKey, boolean cached) {
        return super.getById(super.getMClass(), primaryKey, cached);
    }

    protected TModel get(String sql, Object... params) {
    ...
    protected TModel get(Sql sql, boolean cached) {
    ...
    @Override
    public int update(TModel model, String columns) {
    ...
    @Override
    public int update(Collection<TModel> models, String columns) {
    ...
    @Override
    public int deleteByField(String fieldName, Object... params) {
        return super.deleteByField(super.getMClass(), fieldName, params);
    }

    @Override
    public int deleteByField(String fieldName, Collection params) {
        return super.deleteByField(super.getMClass(), fieldName, params);
    }
